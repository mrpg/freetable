...
\begin{tabularx}{\linewidth}{@{} X *{2}{S[table-format = 3.5, table-column-width = 0.175\linewidth]} @{}}  % !
\toprule
 & {Model 1} & {Model 2} \\
\midrule
...
\begin{table}[h!]
    ...
    \setlength{\customcolwidth}{0.175\linewidth}
    \begin{booktabs}[
        caption = {Regression Results},
        ...
        cell{4}{3} = {appto = {^{**}}},
        cell{6}{3} = {appto = {^{***}}},
        colspec = {X *{2}{S[table-format = 3.5, table-column-width = 0.175\linewidth]}},
...
\sisetup{parse-numbers=false}
\begin{threeparttable}
\begin{tabularx}{\linewidth}{@{} X *{3}{S[table-format = 3.5, table-column-width = 0.175\linewidth]} @{}}  % !
\toprule
